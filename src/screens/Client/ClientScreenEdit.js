...
import { useUpdateClient } from '../../services/ClientService';

const ClientScreenEdit = (props) => {
  ...
  useEffect(() => {
    ...
    setClientId(props.route.params.client.id);
    setAddr1(props.route.params.client.addr1);
    setAddr2(props.route.params.client.addr2);
    setAddr3(props.route.params.client.addr3);
    setAddr4(props.route.params.client.addr4);
    setPostCode(props.route.params.client.postCode);
    setFax(props.route.params.client.fax);
    setEmail(props.route.params.client.email);
    setName(props.route.params.client.name);
    setShortname(props.route.params.client.shortname);
    setDescription(props.route.params.client.description);
    setCountry(props.route.params.client.country);
    setRepresentative(props.route.params.client.representative);
    setContactNumber(props.route.params.client.contactNumber);
    setRemark(props.route.params.client.remark);
...
export default ClientScreenEdit;
